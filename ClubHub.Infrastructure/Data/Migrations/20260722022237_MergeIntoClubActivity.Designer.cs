...
namespace ClubHub.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260722022237_MergeIntoClubActivity")]
    partial class MergeIntoClubActivity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ClubHub.API.Entities.ClubMember", b =>
                {
                    ...
                    b.Property<Guid?>("SuccessorUserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClubHub.API.Entities.ProposalRevision", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ClubHub.API.Entities.User", b =>
                {
                    ...
                    b.Property<string>("EmailVerifyOtp")
                        .HasColumnType("nvarchar(max)");

                    b.Property<DateTime?>("EmailVerifyOtpExpiry")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("ClubHub.API.Entities.ProposalRevision", b =>
                {
                    b.HasOne("ClubHub.API.Entities.ClubProposal", "Proposal")
                        .WithMany()
